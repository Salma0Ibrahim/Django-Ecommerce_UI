...
const Footer = () => {
  return (
    <footer className="footer text-muted py-5">
      <div className="container">
        <div className="row">
          <div className="col-lg-4 mb-4 mb-lg-0">
          <div className="company-title" style={{textAlign:'left',marginTop:'-20px',marginBottom:'10px'}}>
          <span>electric</span>
          <br />
          products
        </div>
          ...
          <div className="col-lg-3">
            ...
            <ul className="list-unstyled mb-0 footer-links">
              <li>
                <a href="#" className="text-reset">Shop All</a>
              </li>
              <li>
                <a href="#" className="text-reset">Electric Products</a>
              </li>
              <li>
          ...
          <input type='text' className='form-control' placeholder='enter your feedback...' />
