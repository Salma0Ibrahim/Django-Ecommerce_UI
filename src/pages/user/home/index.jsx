                        ...
                        <div className="col-lg-6 mb-0 d-flex align-items-center">
                            <div className="text-align-left align-self-center">
                                ...
                                <p>
                                    ...
                                    This template is 100% free provided by <a rel="sponsored" className="text-success" href="#">TemplateMo</a> website. 
                                    Image credits go to <a rel="sponsored" className="text-success" href="#">Freepik Stories</a>,
                                    <a rel="sponsored" className="text-success" href="#">Unsplash</a> and
                                    <a rel="sponsored" className="text-success" href="#">Icons 8</a>.
                                </p>
                            </div>
                        </div>
                    </div>
